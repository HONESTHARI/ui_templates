...
export default function Ph_sidenav() {
  return (
    <div>
      {/* <!-- component -->
...
<body class = "body bg-white dark:bg-[#0F172A]"> */}
      ...
      <aside class="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
        {/* <!-- open sidebar button --> */}
        <div class="max-toolbar translate-x-24 scale-x-0 w-full -right-6 transition transform ease-in duration-300 flex items-center justify-between border-4 border-white dark:border-[#0F172A] bg-[#1E293B]   top-2 rounded-full h-12">
        ...
        <div
          onclick="openNav()"
          class="-right-6 transition transform ease-in-out duration-500 flex border-4 border-white dark:border-[#0F172A] bg-[#1E293B] dark:hover:bg-blue-500 hover:bg-purple-500  top-2 p-3 rounded-full text-white hover:rotate-45"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <div class="content transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        <nav class = "flex px-5 py-3 text-gray-700  rounded-lg bg-gray-50 dark:bg-[#1E293B] " aria-label="Breadcrumb">
            ...
            {/* <h1 className='text-blue-800 text-center font:bold text-xl'>Home</h1> */}
            ...
            <div class="flex flex-col-2 justify-center mx-auto flex-grow ">
                  {/* <div class=" flex text-xl text-white font-semibold font-serif justify-center mx-auto whitespace-nowrap dark:text-gray-400 dark:hover:text-white">
                  <svg class = "w-5 h-5 mr-2  " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path></svg>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-5 text-white">
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        ...
        <div class="flex flex-wrap my-5 ">
          <div class="w-1/2 lg:w-1/3 p-2 h-1/2">
            <div class=" items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
              <div class="text-indigo-500 dark:text-white items-center mx-auto bg-white dark:bg-[#0F172A] p-3  rounded-full flex-none w-20 h-20 md:w-20 md:h-20 ">
                ...
                <img
                  ...
                  src="https://img.freepik.com/free-vector/credit-card-landing-page-payment-concept_23-2148298750.jpg?size=338&ext=jpg&uid=R79864942&ga=GA1.2.553050051.1675165316&semt=sph"
                  alt="payment image"
                />
              </div>

              <div class="flex items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
                <div class="flex flex-col justify-center mx-auto flex-grow  text-white">
                  <div class="text-lg font-semibold font-serif justify-center mx-auto  whitespace-nowrap text-white">
                    Payments
                  </div>
                  {/* <div class = "text-white">
                            100
          ...
          <div class="w-1/2 lg:w-1/3 p-2 h-1/2">
            <div class=" items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
              <div class="text-indigo-500 dark:text-white items-center mx-auto bg-white dark:bg-[#0F172A] p-3  rounded-full flex-none w-20 h-20 md:w-20 md:h-20 ">
                ...
                <img
                  class="object-scale-down transition duration-500 "
                  src="https://img.freepik.com/free-icon/mobile_318-535832.jpg?size=338&ext=jpg&uid=R79864942&ga=GA1.1.553050051.1675165316&semt=ais"
                  alt="payment image"
                />
              </div>
          ...
          <div class="w-1/2 lg:w-1/3 p-2 h-1/2">
            <div class=" items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
              <div class="text-indigo-500 dark:text-white items-center mx-auto bg-white dark:bg-[#0F172A] p-3  rounded-full flex-none w-20 h-20 md:w-20 md:h-20 ">
                ...
                <img
                  class="object-scale-down transition duration-500 "
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL3nOaxxfPtsn81K8_ugg7U__OWyI8t1oaRw&usqp=CAU"
                  alt="payment image"
                />
              </div>
          ...
          <div class="w-1/2 lg:w-1/3 p-2 h-1/2">
            <div class=" items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
              <div class="text-indigo-500 dark:text-white items-center mx-auto bg-white dark:bg-[#0F172A] p-3  rounded-full flex-none w-20 h-20 md:w-20 md:h-20 ">
                ...
                <img
                  class="object-scale-down transition duration-500 "
                  src="https://img.freepik.com/free-vector/push-notifications-concept-illustration_114360-4986.jpg?size=338&ext=jpg&uid=R79864942&ga=GA1.1.553050051.1675165316&semt=sph"
                  alt="payment image"
                />
              </div>
          ...
          <div class="w-1/2 lg:w-1/3 p-2 h-1/2">
            <div class=" items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
              <div class="text-indigo-500 dark:text-white items-center mx-auto bg-white dark:bg-[#0F172A] p-3  rounded-full flex-none w-20 h-20 md:w-20 md:h-20 ">
                ...
                <img
                  class="object-scale-down transition duration-500 "
                  src="https://img.lovepik.com/element/45012/4723.png_860.png"
                  alt="payment image"
                />
              </div>
          ...
          <div class="w-1/2 lg:w-1/3 p-2 h-1/2">
            <div class=" items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
              <div class="text-indigo-500 dark:text-white items-center mx-auto bg-white dark:bg-[#0F172A] p-3  rounded-full flex-none w-20 h-20 md:w-20 md:h-20 ">
                ...
                <img
                  class="object-scale-down transition duration-500 "
                  src="https://img.freepik.com/free-vector/flat-design-illustration-customer-support_23-2148887720.jpg?size=338&ext=jpg&uid=R79864942&ga=GA1.1.553050051.1675165316&semt=ais"
                  alt="payment image"
                />
              </div>
          ...
          <div class="w-1/2 md:w-1/2 lg:w-1/3 p-2 ">
            <div class="flex items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-pink-500 rounded-md p-3">
